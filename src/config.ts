export const SITE = {
  ...
  subtitles: {
    'zh-cn': '记录 Web 安全、CTF 题解与 Agent 渗透实验',
    en: 'Web security, CTF writeups, and agent pentest experiments',
  },
  descriptions: {
    'zh-cn': 'A1right 的双语网络安全博客，聚焦 Web 安全、CTF 题解和 Agent 渗透，并采用 Firefly 风格首页与轻量静态部署。',
...
export const UI = {
  'zh-cn': {
    ...
    search: '搜索',
    searchShort: '搜索',
    searchPlaceholder: '搜索标题、摘要、标签或正文片段…',
    searchEmpty: '没有找到匹配内容，试试换个关键词。',
    searchRecent: '快速查看',
    searchHint: 'Ctrl/⌘ + K 打开，↑↓ 切换，Enter 直达，Esc 关闭',
    close: '关闭',
    switchLanguage: 'English',
    switchLanguageLabel: '切换到英文',
    themeLabel: '切换明暗主题',
    footerNote: 'Astro + Pagefind + Cloudflare Pages，把安全笔记做成更清爽的 Firefly 风格个人站。',
  },
  en: {
    home: 'Home',
    posts: 'Stories',
    categories: 'Categories',
    categoriesHub: 'Categories',
    lab: 'Lab',
    tags: 'Tags',
    tagsHub: 'Tags',
    latest: 'Latest Posts',
    ...
    search: 'Search',
    searchShort: 'Search',
    searchPlaceholder: 'Search titles, excerpts, tags, or article text…',
    searchEmpty: 'No matching content yet. Try another keyword.',
    searchRecent: 'Quick picks',
    searchHint: 'Ctrl/⌘ + K opens search, ↑↓ switches, Enter opens, Esc closes',
    close: 'Close',
    switchLanguage: '中文',
