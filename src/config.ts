export const SITE = {
  ...
  provisionalUrl: 'https://itsa1right.ink', avatarText: 'A1', socialImage: '/images/anime-hero-city.jpg',
...
export const CMS = { repo: 'qsuperm/A1right-blog', branch: 'master', locale: 'zh_Hans', mediaFolder: 'public/images/uploads', publicFolder: '/images/uploads', authEndpoint: 'https://a1right-blog.3223771807.workers.dev/api/auth' } as const;
